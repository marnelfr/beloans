                        ...
                        <div-- class="box-body no-padding">
                                ...
                                <table id="example1" class="table table-bordered table-striped" style="text-align: center">
                                    ...
                                    foreach($messages as $message):
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><a href="index.php?p=user/read&ref=<?= $message->idMessage ?>&fr=b"><?= $message->prenom ?> <?= $message->nom ?></a></td>
                                            <td class="mailbox-subject"><b><?= $message->sujet ?></b></td>
                            ...
                            <div class="box-footer no-padding">
                                <div class="mailbox-controls">
                                    <div class="btn-group">
                                        <button type="submit" class="btn btn-default btn-sm" title="Supprimés messages"><i class="fa fa-trash-o"></i></button>
                                    </div>
                                    <a href="index.php?p=user/draft">
                                        <button class="btn btn-default btn-sm" title="Actuliser"><i class="fa fa-refresh"></i></button>
                                    </a>
                                </div>
                            </div>
                    </form>
