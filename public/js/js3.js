...
$(function() {
  ...
  /* set Android to show/hide PP Apps download banner */
  var $androidSmartBanner = $('.smart-banner');
  if (typeof(Storage) !== 'undefined') {
    // check if value exists
    if (localStorage.getItem('androidSmartBanner') !== 'hide') {
      $androidSmartBanner.removeClass('hide');
    }
    // closing android-banner
    $('.smart-banner .close').on('click', function() {
      $androidSmartBanner.addClass('hide');
      localStorage.setItem('androidSmartBanner', 'hide');
    });
  } else {
    // default is show banner
    $androidSmartBanner.removeClass('hide');
  }
});
